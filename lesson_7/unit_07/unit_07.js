...
function t2() {
    ...
    let out2 = document.querySelector('.out-2').textContent = a2
...
function t6(a, b) {
    ...
    return Math.floor(Math.random() * (b - a + 1)) + a; // подсмотрел в нете не силен в математике;
}
...
function t7() {
    ...
    return `rgb(${t6(0, 255)},${t6(0, 255)}, ${t6(0, 255)})`; // в верстке задал высоту атрибутом;
