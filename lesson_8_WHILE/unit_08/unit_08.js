...
function t2() {
    ...
    document.querySelector('.out-2').textContent = str2;
}
...
function t3() {
    ...
    document.querySelector('.out-3').textContent = str3;
}
...
function t5() {
    ...
    while (i <= 17) {
        if (i % 2 === 0) {
            str5 = str5 + i + '_**';
        } else str5 = str5 = str5 + i + '_*';
        i++;
    }
    document.querySelector('.out-5').textContent = str5;
...
function t13() {
    ...
    let inpArr = document.querySelectorAll('.i-13');
    let i = 0;
    ...
    document.querySelector('.out-13').textContent = inpArr[i];
}
...
function t14() {
    ...
    let inpArr = document.querySelectorAll('.i-14');
    let str = '';
    let i = 0;
