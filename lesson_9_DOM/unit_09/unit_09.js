...
function f13() {
    ...
    let newElem = document.createElement('div');
    newElem.textContent = 'pushMe';
    newElem.classList.add('bg-13');
    newElem.onclick = f13_1;
    out13.appendChild(newElem);
...
function f16() {
    ...
    let newElem = document.createElement('div');
    newElem.textContent = '16';
    newElem.classList.add('bg-16');
    out16.after(newElem);
...
// Функция с помощью getAttribute получает data - b атрибут с параграфов p - 19 
// и выводит в out - 19 через пробел.Обратите внимание, что элементов p - 19 больше одного.
