...
function t2() {
    ...
    for (i = 2; i <= 122; i = i + 2) {
        ...
        answ2 = answ2 + i + ' '; //answ2 += i;

    }

    out2.innerHTML = answ2;
...
function t6() {
    ...
    document.querySelector('.out-6').innerHTML = answ6;
}
...
let out7 = document.querySelector('.out-7'),
    inp7 = document.querySelector('.i-7');
...
function t9() {
    ...
    let val91 = inp91.value,
        val92 = inp92.value,
        answ9 = '';

    if (val91 < val92) {

        for (i = val91; i <= val92; i++) {
        ...
        for (i = val92; i <= val91; i++) {

            answ9 = answ9 + i + ' ';
        }
    }

    out9.textContent = answ9;
