...
function t1() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=1')
     .then(resp => resp.text())
      .then(resp => document.querySelector('.out-1').innerHTML = resp)
}
...
function t2() {
    ...
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-2').innerHTML = resp)
}
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=3&num1=23&num2=32')
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-3').innerHTML = resp)
}
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=4&num1=22&num2=22')
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-4').innerHTML = resp)
}
...
function t5() {
    ...
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-5').innerHTML = resp)
}
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=6&num1=121&num2=345')
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-6').innerHTML = resp)
}
...
function t7() {
    ...
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-7').innerHTML = resp)
}
...
function t8() {
    ...
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-8').innerHTML = resp)
}
...
function t9() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=9&m=1&d=1&y=1')
    .then(resp => resp.text())
     .then(resp => document.querySelector('.out-9').innerHTML = resp)
}
...
function t10() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=1', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-10').innerHTML = respons
    });    
}
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=2&name=Vladimir', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-11').innerHTML = respons
    });
}
...
function t12() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=3&num1=34&num2=567', {
        method: 'POST',       
        headers: {        
          'Content-Type': 'application/x-www-form-urlencoded',
        },      
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-12').innerHTML = respons
    });
  }
...
function t13() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=4&num1=100&num2=200', {
        method: 'POST',       
        headers: {        
          'Content-Type': 'application/x-www-form-urlencoded',
        },      
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-13').innerHTML = respons
    });
...
function t14() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=5', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-14').innerHTML = respons
    });
}
...
function t15() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=6&num1=345&num2=321', {
        method: 'POST',       
        headers: {        
          'Content-Type': 'application/x-www-form-urlencoded',
        },      
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-15').innerHTML = respons
    });
}
...
function t16() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=7', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-16').innerHTML = respons
    });
...
function t17() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=8&year=1980', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-17').innerHTML = respons
    });
...
function t18() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=37A38D7d5b44Dd6D856478D8&action=9&m=1&d=1&y=1', {
      ...
      .then(response => response.text())
       .then(respons => {
        document.querySelector('.out-18').innerHTML = respons
    });
