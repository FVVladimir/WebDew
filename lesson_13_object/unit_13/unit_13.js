...
// Функция должна вывести в out - 1 значение сохраненное под ключем two из массива a1.
...
// Функция должна вывести в out - 2 значение hi из массива a2.Возвратите это значение.
...
// Функция f4 жестко привязана к массиву a4.
// Это не удобно.Давайте напишем функцию f5,
// которая принимает массив как параметр
...
function f6() {
    ...
    let ourKey = document.querySelector('.i-61').value;
    let ourValue = document.querySelector('.i-62').value;
...
// Функция должна выводить значение в out - 8,
...
// Функция должна вывести в out - 9 все ключи массива a9,
// которые содержат значение, равное значению в input.i - 9.
...
// Давайте напишем полезную функцию f10,
// которая проверяет есть ли значение в ассоциативном массиве.
...
// Функция должна в out - 14 выводить нулевые(по индексу)  элементы вложенных массивов в a14.
// Вывод через пробел.
...
// Функция должна в out - 15 выводить элементы вложенных массивов в a15.
// Вывод через пробел.
...
// Функция должна в out - 16 выводить элементы name вложенных массивов в a16.Вывод через пробел.
...
// Функция должна в out - 18 вывести станции метро из массива a18 той ветки,
// которую пользователь ввел в i - 18.
...
// Пользователь может вводить текст как с большой,
// так и с маленькой буквы. Если ветка не найдена - выводите пустую строку.
...
function f19() {
    let a = '';
    let stantion = document.querySelector('.i-19').value.toLowerCase();

    for (let key in a19) {
        for (i = 0; i < a19[key].length; i++) {
            if (a19[key][i].toLowerCase() == stantion) {
