...
let out6 = document.querySelector('.out-6'),
    inp6 = document.querySelector('.i-6');

function f6() {
    out6.innerHTML = inp6.value;
}
...
let inp7 = document.querySelector('.i-7'),
    out71 = document.querySelector('.out-71'),
    out72 = document.querySelector('.out-72');
...
function f7() {
    ...
    out71.innerHTML = a;
    console.log(a);
    // a.length >= 6 ? out72.textContent = '1' : '0';
...
function f8() {
    ...
    out8.innerHTML = '<input type="text" class="i-81"> <button class="b-81">push</button>';
...
let txAr = document.querySelector('.t-14'),
    out14 = document.querySelector('.out-14');

function f14() {

    out14.textContent = txAr.value;
...
let txAr15 = document.querySelector('.t-15'),
    inp15 = document.querySelector('.i-15'),
    out15 = document.querySelector('.out-15');

function f15() {

    txAr15.value = inp15.value;
    out15.textContent = inp15.value;
...
let sel18 = document.querySelector('.s-18'),
    inp18 = document.querySelector('.i-18');

function f18() {

    inp18.value = sel18.value;
...
let inp191 = document.querySelector('.i-191'),
    inp192 = document.querySelector('.i-192'),
    out19 = document.querySelector('.out-19');

function f19() {

    out19.textContent = inp191.value + ' ' + inp192.value;
...
let out20 = document.querySelector('.out-20'),
    inputs = document.querySelector('.f-20').elements,
    inp201 = inputs["username"],
    inp202 = inputs["password"];
...
function f20(e) {
    ...
    out20.textContent = inp201.value + ' ' + inp202.value;
