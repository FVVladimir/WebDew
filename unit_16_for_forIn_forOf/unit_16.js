...
// Функция перебирает массив a1  c помощью цикла for
...
// Функция перебирает массив a2  c помощью цикла for 
...
// Функция получает div.out - 3 со страницы с помощью getElementsByClassName
...
//  а значения - имя (т.е { 23 : Ivan, 45 : Petr}. Функция должна возвращать результирующий массив.
